...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'realtime', name: 'Realtime', component: () => import('../views/dashboard/Realtime.vue'), meta: { title: '实时数据', icon: 'DataBoard' } },
      { path: 'screen', name: 'Screen', component: () => import('../views/dashboard/Screen.vue'), meta: { title: '数据大屏', icon: 'Monitor' } },
      ...
      { path: 'topology', name: 'Topology', component: () => import('../views/devices/Topology.vue'), meta: { title: '设备拓扑', icon: 'Share' } },
      ...
      { path: 'scada', name: 'Scada', component: () => import('../views/scada/Index.vue'), meta: { title: 'SCADA 画面', icon: 'Picture' } },
