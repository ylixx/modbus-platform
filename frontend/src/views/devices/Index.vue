<template>
  <div>
    <div class="page-header">
      <h2>设备管理</h2>
      <p>管理 Modbus TCP / MQTT / OPC-UA 设备（支持 ThingsBoard 格式）</p>
    </div>
    ...
    <!-- Dialog -->
    <el-dialog v-model="dialogVisible" :title="editingId ? '编辑设备' : '新增设备'" width="700px" top="5vh">
      <el-form :model="form" label-width="110px">
        ...
        <el-row :gutter="16">
          ...
          <el-col :span="6">
            <el-form-item label="采集周期(s)"><el-input-number v-model="form.poll_interval" :min="1" :max="3600" /></el-form-item>
          </el-col>
          <el-col :span="6">
        ...
        <el-row :gutter="16">
          <el-col :span="8"><el-form-item label="厂区"><el-input v-model="form.factory" placeholder="e.g. 一号厂区" /></el-form-item></el-col>
          <el-col :span="8"><el-form-item label="车间"><el-input v-model="form.workshop" placeholder="e.g. A车间" /></el-form-item></el-col>
          <el-col :span="8"><el-form-item label="产线"><el-input v-model="form.production_line" placeholder="e.g. 1号线" /></el-form-item></el-col>
        </el-row>
        <el-row :gutter="16">
          <el-col :span="12"><el-form-item label="安装位置"><el-input v-model="form.installation" placeholder="e.g. 3号机组东侧" /></el-form-item></el-col>
          <el-col :span="6"><el-form-item label="经度"><el-input-number v-model="form.longitude" :step="0.0001" :precision="6" style="width:100%" /></el-form-item></el-col>
          <el-col :span="6"><el-form-item label="纬度"><el-input-number v-model="form.latitude" :step="0.0001" :precision="6" style="width:100%" /></el-form-item></el-col>
        </el-row>
        ...
        <template v-if="form.protocol === 'modbus_tcp'">
          ...
          <el-row :gutter="16">
            <el-col :span="8"><el-form-item label="主机地址" required><el-input v-model="form.host" /></el-form-item></el-col>
            <el-col :span="5"><el-form-item label="端口"><el-input-number v-model="form.port" :min="1" :max="65535" /></el-form-item></el-col>
            <el-col :span="5"><el-form-item label="从站ID"><el-input-number v-model="form.slave_id" :min="1" :max="247" /></el-form-item></el-col>
            <el-col :span="6"><el-form-item label="超时(s)"><el-input-number v-model="form.timeout" :min="1" :max="30" :step="0.5" /></el-form-item></el-col>
          </el-row>
        </template>
        ...
        <template v-if="form.protocol === 'mqtt'">
          ...
          <el-row :gutter="16">
            <el-col :span="12"><el-form-item label="Broker地址" required><el-input v-model="form.mqtt_broker" placeholder="192.168.1.100" /></el-form-item></el-col>
            <el-col :span="5"><el-form-item label="端口"><el-input-number v-model="form.mqtt_port" :min="1" :max="65535" /></el-form-item></el-col>
            <el-col :span="4"><el-form-item label="TLS"><el-switch v-model="form.mqtt_use_tls" /></el-form-item></el-col>
            <el-col :span="3"><el-form-item label="QoS">
              <el-select v-model="form.mqtt_publish_qos">
                <el-option label="0" :value="0" /><el-option label="1" :value="1" /><el-option label="2" :value="2" />
              </el-select>
            </el-form-item></el-col>
          </el-row>
          <el-row :gutter="16">
            <el-col :span="8"><el-form-item label="用户名"><el-input v-model="form.mqtt_username" /></el-form-item></el-col>
            <el-col :span="8"><el-form-item label="密码"><el-input v-model="form.mqtt_password" type="password" show-password /></el-form-item></el-col>
            <el-col :span="8"><el-form-item label="Client ID"><el-input v-model="form.mqtt_client_id" placeholder="自动生成" /></el-form-item></el-col>
          </el-row>
          ...
          <el-row :gutter="16">
            <el-col :span="8">
              <el-form-item label="数据格式">
                <el-select v-model="form.mqtt_payload_format">
            ...
            <el-col :span="8" v-if="form.mqtt_payload_format === 'thingsboard'">
              <el-form-item label="网关模式">
                <el-switch v-model="form.mqtt_is_gateway" />
                <div style="font-size:12px;color:#999;margin-top:4px">一个连接管理多个设备</div>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row :gutter="16">
            <el-col :span="6"><el-form-item label="启用发布"><el-switch v-model="form.mqtt_publish_enabled" /></el-form-item></el-col>
            <el-col :span="10"><el-form-item label="发布Topic"><el-input v-model="form.mqtt_publish_topic" :disabled="!form.mqtt_publish_enabled" /></el-form-item></el-col>
            <el-col :span="4"><el-form-item label="QoS">
              <el-select v-model="form.mqtt_publish_qos" :disabled="!form.mqtt_publish_enabled">
                <el-option label="0" :value="0" /><el-option label="1" :value="1" /><el-option label="2" :value="2" />
              </el-select>
            </el-form-item></el-col>
            <el-col :span="4"><el-form-item label="周期(s)"><el-input-number v-model="form.mqtt_publish_interval" :min="1" :disabled="!form.mqtt_publish_enabled" /></el-form-item></el-col>
          </el-row>
        </template>
        ...
        <template v-if="form.protocol === 'opc_ua'">
          ...
          <el-row :gutter="16">
            <el-col :span="16"><el-form-item label="Endpoint" required><el-input v-model="form.opc_endpoint" placeholder="opc.tcp://192.168.1.100:4840" /></el-form-item></el-col>
            <el-col :span="8"><el-form-item label="命名空间"><el-input-number v-model="form.opc_namespace" :min="0" /></el-form-item></el-col>
          </el-row>
          <el-row :gutter="16">
            <el-col :span="8"><el-form-item label="安全模式">
              <el-select v-model="form.opc_security_mode">
                <el-option label="None" value="None" />
                <el-option label="Basic256Sha256" value="Basic256Sha256" />
                <el-option label="Basic256" value="Basic256" />
              </el-select>
            </el-form-item></el-col>
            <el-col :span="8"><el-form-item label="用户名"><el-input v-model="form.opc_username" /></el-form-item></el-col>
            <el-col :span="8"><el-form-item label="密码"><el-input v-model="form.opc_password" type="password" show-password /></el-form-item></el-col>
          </el-row>
        </template>
      </el-form>
      <template #footer>
...
const defaultForm = {
  ...
  factory: '', workshop: '', production_line: '', installation: '', longitude: null, latitude: null,
...
async function handleDelete(device) {
  await ElMessageBox.confirm(`确定删除设备 "${device.name}"？`, '确认')
